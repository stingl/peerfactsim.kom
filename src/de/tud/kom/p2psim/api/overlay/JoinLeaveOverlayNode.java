 ...
 * @version 05/06/2011
 */
public interface JoinLeaveOverlayNode extends OverlayNode {
	 ...
	 * @return id of the associated join operation, or -1 if no operation is spawned.
	 */
	 ...
	 *            - callback which will receive the operation result (either
	 *            operation succeeds with result==null or fails)
	 * @return id of the associated leave operation, or -1 if no operation is spawned.
	 */
