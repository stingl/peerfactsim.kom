 ...
 * @version 05/06/2011
 */
public interface KBR<T extends OverlayID, S extends OverlayContact<T>> extends
		OverlayNode {
	 ...
	 *            message to the hint
	 */
	public void route(OverlayKey key, Message msg, S hint);
	 ...
	 */
	public List<S> local_lookup(OverlayKey key, int num);
	 ...
	 */
	public List<S> replicaSet(OverlayKey key, int maxRank);
	 ...
	 */
	public OverlayContact<T> getLocalOverlayContact();
	 ...
	 * @return the local <code>OverlayContact</code>
	 */
	public S getOverlayContact(OverlayID id, TransInfo transinfo);
	 ...
	 */
	public KBRLookupProvider<T, S> getKbrLookupProvider();
}
