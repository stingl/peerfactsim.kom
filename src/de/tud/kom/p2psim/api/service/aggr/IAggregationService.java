...
package de.tud.kom.p2psim.api.service.aggr;
 ...
 * @version 05/06/2011
 */
public interface IAggregationService<T extends Object> extends Component {
	...
	public int getAggregationResultMap(
			OperationCallback<IAggregationMap<T>> callback);
	...
	/**
	 * Gets the last stored {@link IAggregationResult}.
	 * 
	 * @param identifier
	 *            The identifier of the value for which an aggregation result
	 *            shall be returned.
	 * @return The last {@link IAggregationResult} for the given identifier. If
