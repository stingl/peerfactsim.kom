...
public class Operations {
	 ...
	 *  TODO: May be set to @deprecated? Give me feedback: leo@relevantmusic.de
	 */
	...
	public static <TResult> OperationCallback<TResult> getEmptyCallback() {
		return Operations.EMPTY_CALLBACK;		//more memory-efficient (one instead of many empty callbacks), 
												//but only good with an @SuppressWarnings above this method
		
		//return new EmptyCallback<TResult>();	//fulfills type safety better, but more memory-consuming
	}
	 ...
	 */
	public static <TResult> int scheduleEmptyOperation(SupportOperations component,
	 ...
	 */
	public static <TResult> Operation<TResult> createEmptyOperation(SupportOperations component,
			OperationCallback<TResult> callback) {
	 ...
	 * @return the created empty operation
	 */
	public static <TResult> Operation<TResult> createEmptyOperationResult(SupportOperations component,
