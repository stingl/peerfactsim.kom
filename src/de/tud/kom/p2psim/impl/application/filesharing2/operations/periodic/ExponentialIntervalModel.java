...
/**
 * Exponential distribution interval model for the PeriodicCapableOperation
 * 
...
public class ExponentialIntervalModel implements IntervalModel {
	...
	/**
	 * Creates a new exponential distributed interval model with the given mean interval.
	 * @param meanInterval
	 */
