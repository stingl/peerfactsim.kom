...
/**
 * Interval model that produces equally distributed intervals between
...
public class MaxMinDistIntervalModel implements IntervalModel {
	 ...
	 * @param minInterval : the minimum value the model may return as an interval.
	 * @param maxInterval : the maximum value the model may return as an interval. 
	 */
