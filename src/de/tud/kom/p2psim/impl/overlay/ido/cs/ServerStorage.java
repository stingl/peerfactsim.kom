...
public class ServerStorage {
	 ...
	 */
	private HashMap<ClientID, ServerStorageContainer> storage;
	...
	public ServerStorage(int maxClients) {
		...
		storage = new HashMap<ClientID, ServerStorageContainer>();
	...
	private boolean inAOI(Point center, Point point, int aoi) {
	 ...
	 * 
	 */
	private class ServerStorageContainer {
