...
package de.tud.kom.p2psim.impl.overlay.ido.psense.visualization;
...
import de.tud.kom.p2psim.impl.overlay.ido.psense.PSenseNodeInfo;
...
public class WorldPanel extends JPanel {
	...
	private void paintStoredPositions(PSenseNode node, Graphics2D g2) {
	...
	private void paintSensorNode(Point position, Graphics2D g2) {
	...
	private void paintNearNode(Point position, Graphics2D g2) {
	...
	private void paintLocalNode(Point position, Graphics2D g2) {
		int radius = NODE_PAINT_RADIUS + DESISTANCE_FROM_NODE_FOR_CIRCLE;
	...
	private void paintOverlayID(String overlayID, Point position, Graphics2D g2) {
		g2.setColor(Color.black);
	...
	private void paintNode(Point position, Graphics2D g2) {
		g2.setColor(Color.BLACK);
