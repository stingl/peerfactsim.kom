...
import de.tud.kom.p2psim.impl.overlay.ido.psense.IncomingMessageBean;
import de.tud.kom.p2psim.impl.overlay.ido.psense.OutgoingMessageBean;
import de.tud.kom.p2psim.impl.overlay.ido.psense.PSense;
...
import de.tud.kom.p2psim.impl.overlay.ido.psense.messages.AbstractPositionUpdateMsg;
...
public class RoundOperation extends AbstractOperation<PSenseNode, Boolean> {
	...
	private void updateNearNodeList(PSense localPSense) {
	...
	private PSenseID[] computeNewSensorNodesFromResponses(
