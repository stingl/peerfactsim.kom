...
/**
 * This class is used to mark messages that are part of the VON overlay. This is
 * needed for evaluation to distinguish the overlays messages from others.
 * 
 * @author Julius Rueckert <peerfact@kom.tu-darmstadt.de>
 * 
 * @version 05/06/2011
 */
public abstract class AbstractVonMsg extends AbstractOverlayMessage<VonID> {

	public AbstractVonMsg(VonID sender, VonID receiver) {
