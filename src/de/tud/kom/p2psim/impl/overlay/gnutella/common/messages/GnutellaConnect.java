 ...
 * @version 05/06/2011
 */
public class GnutellaConnect<TContact extends GnutellaLikeOverlayContact> extends AbstractGnutellaMessage {
	 ...
	 * @param hasLowConnectivity: a flag the indicates if the sender is currently in a low
