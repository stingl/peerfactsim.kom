...
/**
 * Abstract information that is sent with a query. Needed to decide if 
 * a document matches a given query or not.
 * 
...
public interface IQueryInfo {
	 ...
	 * E.g. if this value is > 0, the node that received the query sends
	 * a Query Hit.
	 * @param resourceSet
	 * @return
	 */
	...
	/**
	 * Returns the size of this query information in the transport representation.
	 * @return
	 */
	public int getSize();
