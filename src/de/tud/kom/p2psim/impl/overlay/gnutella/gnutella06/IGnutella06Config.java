...
public interface IGnutella06Config extends IGnutellaConfig {
	...
	/**
	 * Returns the maximum number of connections an ultrapeer may keep to other ultrapeers
	 * @return
	 */
	...
	/**
	 * Returns, whether it is allowed to kick peers randomly in order to have room 
	 * for poorly connected peers.
	 * @return
	 */
	...
	/**
	 * Returns the probability to kick a random peer if a poorly connected one attempts
	 * to connect and the routing table is full.
	 * @return
	 */
	...
	/**
	 * Returns the duration of the controlled broadcast step
	 * in the Dynamic Query operation.
	 * @return
	 */
	...
	/**
	 * Returns the number of TTLs a query can be relayed until
	 * it is dropped.
	 * @return
	 */
	@ConfID("QUERY_DEPTH")
	...
	/**
	 * Returns the duration a leaf waits for a response when it
	 * has requested an ultrapeer to do its query.
	 * @return
	 */
	...
	/**
	 * Returns the probability that a peer is kicked randomly in order
	 * to have room for other peers with low connectivity.
	 * @return
	 */
	@ConfID("RANDOMLY_KICK_PEER_PROB")
