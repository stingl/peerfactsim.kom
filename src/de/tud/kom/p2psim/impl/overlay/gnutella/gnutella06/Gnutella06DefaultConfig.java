...
public class Gnutella06DefaultConfig implements IGnutella06Config{
	...
	private static final Bandwidth MAY_BE_ULTRAPEER_BANDWIDTH = new Bandwidth(100000d,100000d);		//50KByte/s up&down
	private static final Bandwidth MUST_BE_ULTRAPEER_BANDWIDTH = new Bandwidth(2000000d,2000000d);		//2MByte/s up&down
