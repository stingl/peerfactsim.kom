...
/**
 * Gia query message. Very similar to Gnutella-like query messages, but designed for biased random walks.
 * 
...
public class GiaQueryMessage extends GiaMessage {
	...
	public GiaQueryMessage(GiaOverlayContact initiator, GiaOverlayContact lastHop, Query q, int wantedResponses) {
	...
	public String toString() {
		return "QUERY_MSG: (uid=" + q.getQueryUID() + ", init=" + initiator + ", lstHp=" + lastHop + ", q=" + q + ", hops=" + hops + ")";
	}
