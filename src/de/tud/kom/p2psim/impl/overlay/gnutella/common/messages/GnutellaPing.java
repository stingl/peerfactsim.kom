...
/**
 * The ping message is periodically sent to neighbors in order to 
 * check their liveness and to request liveness information
 * 
 * @author Leo Nobach <peerfact@kom.tu-darmstadt.de>
 *
 * @version 05/06/2011
 */
public class GnutellaPing<TContact extends GnutellaLikeOverlayContact> extends AbstractGnutellaMessage {
