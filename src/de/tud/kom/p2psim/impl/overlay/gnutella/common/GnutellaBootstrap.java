...
/**
 * Bootstrapping component for Gnutella-like overlays. Peers that successfully connected
 * to the overlay leave their contact information here. If a peer wants to connect to the
 * overlay at startup, it gets a random contact from this pool for its bootstrap.
 * 
