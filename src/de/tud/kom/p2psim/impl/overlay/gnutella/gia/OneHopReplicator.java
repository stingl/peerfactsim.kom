 ...
 * @version 05/06/2011
 */
public class OneHopReplicator implements ConnectionManagerListener<GiaOverlayContact, GiaConnectionMetadata> {
	...
	@Override
	public void connectionEnded(GiaOverlayContact c, GiaConnectionMetadata metadata) {
	...
	@Override
	public void newConnectionEstablished(GiaOverlayContact c, GiaConnectionMetadata metadata) {
		new UpdateDocumentsOperation<GiaOverlayContact>(component, mgr, c, Operations.getEmptyCallback())
