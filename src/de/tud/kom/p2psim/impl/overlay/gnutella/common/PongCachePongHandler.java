...
/**
 * Manages incoming pong messages and creates outgoing ones.
 * Keeps the pong cache up-to-date and tells the connection 
 * manager about freshly discovered nodes.
 * 
 * @author Leo Nobach <peerfact@kom.tu-darmstadt.de>
 *
 * @version 05/06/2011
 */
public abstract class PongCachePongHandler<TContact extends GnutellaLikeOverlayContact, 
	TPongMsg extends GnutellaPong<TContact>> implements IPongHandler<TContact, TPongMsg> {
	 ...
	 * @param node
	 */
	public PongCachePongHandler(AbstractGnutellaLikeNode<TContact, ?> node, ConnectionManager<?, TContact, ?, TPongMsg> mgr) {
	...
	protected void updatePongCache(PongCache<TContact> remotePongCache,
		...
		Set<GnutellaLikeOverlayContact> seenContacts = new HashSet<GnutellaLikeOverlayContact>();
