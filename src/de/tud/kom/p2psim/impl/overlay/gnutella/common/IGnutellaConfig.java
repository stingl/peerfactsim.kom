...
public interface IGnutellaConfig {
	...
	/**
	 * Returns the number of connection attempts before a contact is marked as stale.
	 * @return
	 */
	...
	/**
	 * Returns the required hit count that is necessary to mark
	 * a query as succeeded.
	 * @return
	 */
	...
	/**
	 * Returns if only the last entry of a received pong cache shall be 
	 * taken into account as a new discovered peer.
	 * @return
	 */
	...
	/**
	 * Returns the bootstrap interval between two bootstrap attempts
	 * of the same node.
	 * @return
	 */
	...
	/**
	 * Returns a routing table size limit when peers received via the "TryUltrapeers" shall not
	 * be added to the routing table anymore.
	 * @return
	 */
	...
	/**
	 * Returns the size of the "TryUltrapeers" list that is returned when a connection
