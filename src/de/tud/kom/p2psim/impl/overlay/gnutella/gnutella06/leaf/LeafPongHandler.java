...
/**
 * The pong handler of a leaf just replies with an empty pong 
 * without a pong cache or any other node discovery information. 
 * It receives pong caches from the ultrapeer
 * to receive fresh nodes to connect to in case of a failure.
 * 
 * @author Leo Nobach  <peerfact@kom.tu-darmstadt.de>
 *
 * @version 05/06/2011
 */
public class LeafPongHandler implements IPongHandler<Gnutella06OverlayContact, GnutellaPong<Gnutella06OverlayContact>> {
	...
	/**
	 * Updates live node information from the received pong cache
	 * and tells it to the connection manager.
	...
	private void update(PongCache<Gnutella06OverlayContact> remotePongCache,
		...
		Set<Gnutella06OverlayContact> seenContacts = new HashSet<Gnutella06OverlayContact>();
	...
	public void setConnectionManager(ConnectionManager<?, Gnutella06OverlayContact, ?, GnutellaPong<Gnutella06OverlayContact>> mgr) {
		this.mgr = mgr;
	}
	...
	public GnutellaPong<Gnutella06OverlayContact> generatePongMessage(
		...
		return new GnutellaPong<Gnutella06OverlayContact>(ownContact, null); // Leaves have no pong
														// cache
	}
