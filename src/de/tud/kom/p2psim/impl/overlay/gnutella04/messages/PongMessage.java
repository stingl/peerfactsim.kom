...
public class PongMessage extends BaseMessage {
	...
	private static final long GNUTELLA_PONG_MESSAGE_SIZE = 14;

	private OverlayContact<GnutellaOverlayID> contact;

	public PongMessage(GnutellaOverlayID sender, GnutellaOverlayID receiver,
	...
	public long getSize() {
		return super.getSize() + GNUTELLA_PONG_MESSAGE_SIZE;
	}
}
