 ...
 * @version 05/06/2011
 */
public class NotifyPredecessorMsg extends ChordMessage implements IStabilizeMessage{
	
	private ChordContact predecessor;
	
	public NotifyPredecessorMsg(ChordContact senderContact, ChordContact receiverContact,
