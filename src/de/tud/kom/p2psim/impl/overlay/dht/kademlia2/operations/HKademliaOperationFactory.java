...
import de.tud.kom.p2psim.impl.overlay.dht.kademlia2.operations.lookup.BucketLookupOperation.HierarchicalBucketLookupOperation;
import de.tud.kom.p2psim.impl.overlay.dht.kademlia2.operations.lookup.ClusterPreferenceLookupCoordinator;
import de.tud.kom.p2psim.impl.overlay.dht.kademlia2.operations.lookup.LookupCoordinator.HierarchicalLookupCoordinator;
import de.tud.kom.p2psim.impl.overlay.dht.kademlia2.operations.lookup.LookupCoordinator.NonhierarchicalLookupCoordinator;
import de.tud.kom.p2psim.impl.overlay.dht.kademlia2.operations.lookup.RoundbasedLookupCoordinator;
 ...
 * routing and a customised bucket refresh lookup.
 * 
 * @author Tobias Lauinger <tl1003@rbg.informatik.tu-darmstadt.de>
 * @version 05/06/2011
 */
public class HKademliaOperationFactory<H extends HKademliaOverlayID> extends
		AbstractOperationFactory<H> implements OperationFactory<H> {

	/**
	 * The node that owns this operation factory
	 */
	private final HKademliaNode<H> myNode;
	 ...
	 * 
	 * @param myNode
	 *            the HKademliaNode that owns this operation factory.
	 * @param conf
	 *            an OperationsConfig reference that permits to retrieve
	 *            configuration "constants".
	 */
	public HKademliaOperationFactory(final HKademliaNode<H> myNode,
	...
	public final KademliaOperation<List<KademliaOverlayContact<H>>> getBucketLookupOperation(
		...
		final HierarchicalLookupCoordinator<H> coord = new RoundbasedLookupCoordinator<H>(
				key, myNode, config.getHierarchyDepth(), config);
		final KademliaOperation<List<KademliaOverlayContact<H>>> op = new HierarchicalBucketLookupOperation<H>(
				bucketDepth, coord, myNode, opCallback, Reason.MAINTENANCE,
				config);
		return op;
	}
