 ...
 * @version 05/06/2011
 */
public class KBRKademliaNode<T extends KademliaOverlayID> extends
		KademliaNode<T> implements KBR<T, KademliaOverlayContact<T>> {

	private final static Logger log = SimLogger
			.getLogger(KBRKademliaNode.class);

	private KBRListener kbrListener;

	private KBRLookupProvider<T, KademliaOverlayContact<T>> kbrLookupProvider;

	public KBRKademliaNode(KademliaOverlayContact<T> myContact,
