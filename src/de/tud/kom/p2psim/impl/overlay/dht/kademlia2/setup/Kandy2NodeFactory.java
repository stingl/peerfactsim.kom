...
import de.tud.kom.p2psim.impl.overlay.dht.kademlia2.components.Kandy2Node;
 ...
 * @version 05/06/2011
 */
public class Kandy2NodeFactory extends HAbstractNodeFactory {

	private final static Logger log = SimLogger
			.getLogger(Kandy2NodeFactory.class);

	public Kandy2NodeFactory() {
	 ...
	 */
	@Override
	protected Kandy2Node<HKademliaOverlayID> buildHierarchicalNode(
		...
		final Kandy2Node<HKademliaOverlayID> newNode = new Kandy2Node<HKademliaOverlayID>(
