 ...
 */
public class ClientLeaveOperation extends
		AbstractOperation<NapsterClientNode, Object> implements
	...
	public ClientLeaveOperation(NapsterClientNode component,
		...
		if (getComponent().getServerOverlayContact() != null
			...
			request = new ClientLeaveRequestMsg(ownOID, serverOID, null,
					getOperationID());
		}
	}
