...
public abstract class BucketLookupOperation<T extends KademliaOverlayID>
	 ...
	 * @author Tobias Lauinger <tl1003@rbg.informatik.tu-darmstadt.de>
	 */
	public static class HierarchicalBucketLookupOperation<H extends HKademliaOverlayID>
			extends BucketLookupOperation<H> implements
			HierarchicalLookupCoordinatorClient<H> {
		 ...
		 */
		public HierarchicalBucketLookupOperation(final int bucketDepth,
				final HierarchicalLookupCoordinator<H> coordinator,
				final Node<H> node, final OperationCallback opCallback,
		...
		public final void sendLookupMessage(
				final KademliaOverlayContact<H> destination,
				final int minClusterDepth) {
			final KademliaMsg<H> message = new HKClosestNodesLookupMsg<H>(
	...
	public BucketLookupOperation(final int bucketDepth,
		...
		seenValidIDs = new HashSet<T>(config.getBucketSize(), 1.0f);
