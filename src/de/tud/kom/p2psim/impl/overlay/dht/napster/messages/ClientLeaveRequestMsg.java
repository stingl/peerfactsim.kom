 ...
 */
public class ClientLeaveRequestMsg extends AbstractNapsterRequestMsg<Object>
		implements JoinLeaveMessage {

	public ClientLeaveRequestMsg(NapsterOverlayID sender,
			NapsterOverlayID receiver, Object content, int opID) {
