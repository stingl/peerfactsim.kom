 ...
 */
public class ResponsibilityRequestMsg extends
		AbstractNapsterRequestMsg<NapsterOverlayID> implements LookupMessage {

	public ResponsibilityRequestMsg(NapsterOverlayID sender,
			NapsterOverlayID receiver, NapsterOverlayID content, int opID) {
		super(sender, receiver, content, opID);
	}

	@Override
	public long getSize() {
		long newSize = super.getSize() + SkyNetConstants.OVERLAY_ID_SIZE;
		return newSize;
	}
}
