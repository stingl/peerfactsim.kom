 ...
 * but isn't used and implemented right now.
 * 
 * @author  <peerfact@kom.tu-darmstadt.de>
 *
 * @version 05/06/2011
 */
public class CanApplication extends AbstractApplication {
	private CanNode node;

	public CanApplication(CanNode n) {
		this.node = n;
	}

	protected CanNode getNode() {
		return this.node;
	}
