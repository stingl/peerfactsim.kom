...
public class MathHelper {
	...
	private static Logger log = SimLogger.getLogger(MathHelper.class);
	
	private static final BigInteger maxValue = new BigInteger("2").pow(ChordID.KEY_BIT_LENGTH);
	 ...
	 */
	public static BigInteger getFingerStartValue(BigInteger nodeId, int entryIndex) {
		// return n + 2^(k)
