...
public class CanVID{
	...
	/**
	 * Compares two CanVID and if the actual values is higher as
	 * the parameter the return value is true.
	 * 
	 * @param compare
	 * 		CanVID to compare
	 * @return
	 * 		true if actual value is higher
	 */
	public boolean higher(CanVID compare){
		...
		if(out.compareTo(out2)==1){	//VID ist kleiner
			return true;
		}
		else{
			return false; //VID ist größer oder gleich
		}
	}
	
	/**
	 * Compares two CanVID and if the actual values is lower as
	 * the parameter the return value is true.
	 * 
	 * @param compare
	 * 		CanVID to compare
	 * @return
	 * 		true if actual value is lower
	 */
	...
	/**
	 * Compares three CanVID and if the actual values is in between of
	 * the parameter the return value is true.
	 * 
	 * @param compare
	 * 		CanVID to compare
	 * @return
	 * 		true if actual value is in between
	 */
	 ...
	 * 		CanVID to compare
	 * @return
	 * 		true if actual value and compare have the same parents
	 */
