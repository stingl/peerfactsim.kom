...
import de.tud.kom.p2psim.impl.overlay.dht.kademlia2.operations.HKademlia2OperationFactory;
 ...
 * @version 05/06/2011
 */
public class HKademlia2Node<H extends HKademliaOverlayID> extends AbstractKademliaNode<H> implements HierarchyRestrictableNode<H> {
	 ...
	 * operations)
	 */
	private final HKademlia2OperationFactory<H> operationFactory;
	 ...
	 */
	public HKademlia2Node(final KademliaOverlayContact<H> myContact, final TransLayer messageManager, final ComponentsConfig conf) {
		super(myContact, messageManager, conf);
		routingTable = new HKademliaRoutingTable<H>(myContact, conf, this);
		operationFactory = new HKademlia2OperationFactory<H>(this, conf);
	 ...
	 */
	@Override
	public final HKademlia2OperationFactory<H> getOperationFactory() {
