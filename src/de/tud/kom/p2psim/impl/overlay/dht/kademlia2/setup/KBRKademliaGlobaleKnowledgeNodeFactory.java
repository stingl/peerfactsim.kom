 ...
 *
 */
public class KBRKademliaGlobaleKnowledgeNodeFactory extends AbstractNodeFactory {

	private final static Logger log = SimLogger
			.getLogger(KademliaNodeFactory.class);

	public KBRKademliaGlobaleKnowledgeNodeFactory() {
	...
	protected final Node<HKademliaOverlayID> buildNode(
		...
		final KBRKademliaNodeGlobalKnowledge<HKademliaOverlayID> newNode = new KBRKademliaNodeGlobalKnowledge<HKademliaOverlayID>(
