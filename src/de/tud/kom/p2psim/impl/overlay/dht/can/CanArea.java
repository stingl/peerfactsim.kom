...
/**
 * The class for the areas of every peer.
 * The area is saved as short array[4], this class gives some
 * classes to work with the area.  
 * In the CanArea is as well the CanVID address saved.
 * 
...
public class CanArea {
	...
	/**
	 * A CanArea is created with the array of the parameters and
	 * the VID address is added to the CanArea
	 * 
	 * @param x0
	 * @param x1
	 * @param y0
	...
	/**
	 * checks if either the x0 or the x1 value of the actual area 
	 * is located between the x values of the betweenArea  
	 * 
	 * @param betweenArea
	 * @return
	 */
	...
	/**
	 * checks if either the y0 or the y1 value of the actual area 
	 * is located between the y values of the betweenArea  
	 * 
	 * @param betweenArea
	 * @return
	 */
	...
	/**
	 * checks if both x values of the actual area 
	 * is located between the x values of the betweenArea  
	 * 
	 * @param betweenArea
	 * @return
	...
	/**
	 * checks if both y values of the actual area 
	 * is located between the y values of the betweenArea  
	 * 
	 * @param betweenArea
	 * @return
	...
	/**
	 * checks if the actual area has a common X0 corner with the 
	 * betweenArea  
	 * 
	 * @param betweenArea
	 * @return
	...
	/**
	 * checks if the actual area has a common X1 corner with the 
	 * betweenArea  
	 * 
	 * @param betweenArea
	 * @return
	...
	/**
	 * checks if the actual area has a common Y0 corner with the 
	 * betweenArea  
	 * 
	 * @param betweenArea
	 * @return
	...
	/**
	 * checks if the actual area has at least on common corner with the 
	 * testArea  
	 * 
	 * @param betweenArea
	 * @return
	...
	public boolean commonCorner(CanArea testArea){
		if((testArea.getArea()[1] == area[0] && (testArea.betweenYboth(area))) 
				|| (testArea.getArea()[0] == area[1] && (testArea.betweenYboth(area)) ) 
				|| (testArea.getArea()[3] == area[2] && (testArea.betweenXboth(area)) ) 
				|| (testArea.getArea()[2] == area[3] && (testArea.betweenXboth(area)) ) ){
			return true;
		}
		else{
			return false;
	...
	public short[] areaToShort(int[]area){
		short[] areaOut = {(short)area[0],(short)area[1],(short)area[2], (short)area[3]};
		return areaOut;
	}
