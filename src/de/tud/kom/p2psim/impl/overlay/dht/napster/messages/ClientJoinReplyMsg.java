 ...
 */
public class ClientJoinReplyMsg extends
		AbstractNapsterReplyMsg<NapsterOverlayID> implements JoinLeaveMessage {

	public ClientJoinReplyMsg(NapsterOverlayID sender,
			NapsterOverlayID receiver, NapsterOverlayID result, int opID) {
