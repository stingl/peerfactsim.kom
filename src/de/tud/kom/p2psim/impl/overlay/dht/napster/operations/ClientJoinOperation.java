...
public class ClientJoinOperation extends
		AbstractOperation<NapsterClientNode, NapsterOverlayID> implements
		TransMessageCallback {

	private static Logger log = SimLogger.getLogger(ClientJoinOperation.class);
	...
	public ClientJoinOperation(NapsterClientNode component,
			TransInfo ownTransInfo, OperationCallback<NapsterOverlayID> callback) {
	...
	@Override
	public NapsterOverlayID getResult() {
