 ...
 * @version 05/06/2011
 */
public class PastryID implements OverlayID<BigInteger>, Transmitable {
	...
	public PastryID(TransInfo localTransInfo) {
		 ...
		 * generate an Id.
		 */
		id = IDGenerationHelper.getSHA1Hash(localTransInfo.getNetId()
	...
	@Override
	public int compareTo(OverlayID otherID) {
