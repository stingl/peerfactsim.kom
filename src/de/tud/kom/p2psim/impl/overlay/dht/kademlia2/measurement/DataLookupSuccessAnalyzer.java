...
import de.tud.kom.p2psim.impl.overlay.dht.kademlia2.setup.AbstractNodeFactory;
...
public final class DataLookupSuccessAnalyzer extends FileAnalyzer implements
	...
	protected final void started() {
		opBeginnings = new HashMap<Integer, Long>(
				RUNNING_OPERATIONS_STARTING_CAPACITY);
		opMsgClusterDepths = new HashMap<Integer, Map<Integer, Integer>>(
				RUNNING_OPERATIONS_STARTING_CAPACITY);
	...
	public void dataLookupInitiated(final DataLookupOperation<?> op) {
		...
		opMsgClusterDepths.put(opID, new HashMap<Integer, Integer>());
	}
