 ...
 */
public class PredecessorReplyMsg extends
		AbstractNapsterReplyMsg<NapsterOverlayContact> implements LookupMessage {

	public PredecessorReplyMsg(NapsterOverlayID sender,
			NapsterOverlayID receiver, NapsterOverlayContact result, int opID) {
		super(sender, receiver, result, opID);
	}

	@Override
	public long getSize() {
		return super.getSize() + SkyNetConstants.NAPSTER_OVERLAY_CONTACT_SIZE;
	}
