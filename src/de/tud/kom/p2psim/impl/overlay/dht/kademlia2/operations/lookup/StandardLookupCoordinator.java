...
public class StandardLookupCoordinator<T extends KademliaOverlayID> extends
	...
	protected final void init() {
		...
		kClosestNodes.putAll(contactsFromRT, ContactState.TO_QUERY, true);
		/*
	 ...
	 */
	protected Set<KademliaOverlayContact<T>> localLookup(final KademliaOverlayKey key) {
		int localBucketSize = ((AbstractKademliaNode<T>) getNode()).getLocalConfig().getBucketSize();
