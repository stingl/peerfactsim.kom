 ...
 * @version 05/06/2011
 */
final class RefreshNodeVisitor<T extends KademliaOverlayID> extends
	 ...
	 *         immediately).
	 */
	protected static final <T extends KademliaOverlayID> RefreshNodeVisitor<T> getRefreshNodeVisitor(
	...
	public final void visit(final LeafNode<T> node) {
		if (node.lastLookup < 0 // "< 0" means "never set"
				|| node.lastLookup <= notLookedUpAfter) {
