...
public class RoutingTableComparators {
	 ...
	 */
	protected static final Comparator<RoutingTableEntry<? extends KademliaOverlayID>> getLastSeenComp() {
	 ...
	 *         are smaller.
	 */
	protected static final Comparator<RoutingTableEntry<?>> getStaleComparator() {
	 ...
	 * @author Tobias Lauinger <tl1003@rbg.informatik.tu-darmstadt.de>
	 */
	static final class BigIntegerXORMaxComparator extends
	 ...
	 * @author Tobias Lauinger <tl1003@rbg.informatik.tu-darmstadt.de>
	 */
	static final class RoutingTableEntryXORMaxComparator<T extends KademliaOverlayID>
	 ...
	 * @author Tobias Lauinger <tl1003@rbg.informatik.tu-darmstadt.de>
	 */
	static abstract class HierarchyComparator<H extends HKademliaOverlayID> {
		...
		public final int compare(final H o1, final H o2) {
			final int commonCluster1 = reference.getCommonClusterDepth(o1);
			final int commonCluster2 = reference.getCommonClusterDepth(o2);
	 ...
	 * @author Tobias Lauinger <tl1003@rbg.informatik.tu-darmstadt.de>
	 */
	public static final class KademliaOverlayContactHierarchyComparator<H extends HKademliaOverlayID>
	 ...
	 * @author Tobias Lauinger <tl1003@rbg.informatik.tu-darmstadt.de>
	 */
	static final class RoutingTableEntryHierarchyComparator<H extends HKademliaOverlayID>
			extends HierarchyComparator<H> implements
	 ...
	 * @author Tobias Lauinger <tl1003@rbg.informatik.tu-darmstadt.de>
	 */
	static final class StaleComparator implements
			Comparator<RoutingTableEntry<?>> {
