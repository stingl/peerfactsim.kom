...
/**
 * Operations as used in Kandy. These are the same operations as in Kademlia,
 * except that they use a visibility restricted local lookup wherever possible.
 * 
 * @author Tobias Lauinger <tl1003@rbg.informatik.tu-darmstadt.de>
 * @version 05/06/2011
 */
public class KandyOperationFactory<H extends HKademliaOverlayID> extends
	...
	/**
	 * Constructs a new Kandy operation factory for the given
	 ...
	 */
	public KandyOperationFactory(final VisibilityRestrictableNode<H> myNode,
