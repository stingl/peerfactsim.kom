...
public class ValueLookupReplyMessage extends AbstractReplyMsg {
	...
	public ValueLookupReplyMessage(ChordContact senderContact,
			ChordContact receiverContact, DHTObject object) {
	...
	@Override
	public long getSize() {
		return 0 + super.getSize(); // size of DHTObject ist unknown
	}
