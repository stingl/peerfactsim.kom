...
/**
 * Base class for all reply messages
 * 
 * @author Minh Hoang Nguyen  <peerfact@kom.tu-darmstadt.de>
 *
 * @version 05/06/2011
 */
public abstract class AbstractReplyMsg  extends ChordMessage implements Message {

    public AbstractReplyMsg(ChordContact senderContact, ChordContact receiverContact) {
