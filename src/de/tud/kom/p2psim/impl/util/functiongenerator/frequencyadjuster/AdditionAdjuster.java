...
/**
 * This frequency adjuster increases the current
...
public class AdditionAdjuster extends FrequencyAdjuster {
     ...
     * @param value Value by which the frequency is increased
     * @param interval Interval in which the frequency shall be adjusted (0 = non-repeating)
     */
	public AdditionAdjuster(long simTime, Function function, double value, long interval) {
