...
public class FunctionGenerator {
	...
	public double getValue(Class<? extends Function> function) {
		return getValueAt(Simulator.getInstance().getCurrentTime(), function);
	}
	...
	public double getDerivative(Class<? extends Function> function) {
		return getDerivativeAt(Simulator.getInstance().getCurrentTime(),
				function);
	}
	...
	public Map<Class<? extends Function>, Double> getValues() {
		return getValuesAt(Simulator.getInstance().getCurrentTime());
	}
}
