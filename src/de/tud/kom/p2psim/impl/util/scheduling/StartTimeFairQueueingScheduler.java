...
public class StartTimeFairQueueingScheduler<TScheduleObject> implements IScheduler<TScheduleObject> {
	 ...
	 * @param res
	 */
	public StartTimeFairQueueingScheduler(SupportOperations owner, ISchedulableResource<TScheduleObject> res) {
		this.res=res;
		this.owner=owner;
	}
	...
	class WaitForNextService extends AbstractOperation<SupportOperations, Object> {
