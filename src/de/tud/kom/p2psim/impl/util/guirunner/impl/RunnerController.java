...
public class RunnerController implements ActionListener {
	...
	public void invokeRunSimulator() {
		...
		System.out.println("GUIRunner: Starte Simulator mit " + selectedFile.getFile().getAbsolutePath());
	...
	/**
	 * Sets the button that invokes the standalone execution of
	 * the visualization.
	 * @param b
	 */
	...
	private void invokeStartVis() {
		System.out.println("GUIRunner: Starte Visualisierung");
		runner.disposeRunner();
		Controller.init();
	}
