...
import de.tud.kom.p2psim.impl.vis.model.TimelineEventListener;
import de.tud.kom.p2psim.impl.vis.model.VisDataModel;
import de.tud.kom.p2psim.impl.vis.ui.common.densityPane.DensityView;

/**
 * Slider, der es ermöglicht, die Position der Timeline zu ändern.
 * 
...
public class TimelineSlider extends JPanel implements TimelineEventListener,
	...
	public TimelineSlider() {
		...
		if (Controller.getModel() != null) density.setEventTimeline(Controller.getTimeline());
	...
	private void sliderChanged(int sliderValue) {
		...
		this.changeTimeline(timeline_time);
	}

	private void changeTimeline(long time) {
