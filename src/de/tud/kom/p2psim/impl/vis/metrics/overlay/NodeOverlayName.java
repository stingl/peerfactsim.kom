...
/**
 * Name des Overlays/der Overlays, die der Knoten benutzt. (Benutzt
 ...
 * 
 */
public class NodeOverlayName extends OverlayNodeMetric {

	public NodeOverlayName() {
	...
	public String getValue(VisOverlayNode node) {
		Object attr = node.getAttribute("overlay");
