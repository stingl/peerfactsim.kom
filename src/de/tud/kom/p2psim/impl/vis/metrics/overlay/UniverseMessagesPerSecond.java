 ...
 * @version 05/06/2011
 */
public class UniverseMessagesPerSecond extends OverlayUniverseMetric {
	...
	public String getValue() {
		...
		return String.valueOf((float) this.getEventCount(t
				- Player.TIME_UNIT_MULTIPLICATOR * SECONDS_LOOK_BACK, t)
				/ (float) SECONDS_LOOK_BACK);
	}

	protected long getEventCount(long begin, long end) {
