...
/**
 * Ein Peer verlässt das Szenario.
 * 
 * @author Leo Nobach <peerfact@kom.tu-darmstadt.de>
 * 
 * @version 05/06/2011
 */
public class NodeRemoved extends Event implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4888277508741351362L;

	protected VisOverlayNode node;

	public NodeRemoved(VisOverlayNode node) {
		this.node = node;
	}
	...
	public String toString() {
		return "NodeRemoved: " + node.toString();
	}
