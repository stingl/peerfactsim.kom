...
public class MobileMovementManager {
	 ...
	 * @return HopCount (int) between the sender and receiver. If no path is found,
	 * the sender is set offline
	 *
	 */
	 ...
	 * present. If there are nodes in the surrounding area, they are added to a list
	 * with the Euclidean distance to the receiver.
	 * 
	 * @param sender
	 ...
	 * receiver. This method is called until the distance is smaller than sqrt(2). Also the
	 * global deletedList is used. Here the already searched nodes are saved.
	 * 
	 * @param sender
	 *            MobileNode of the sender
	 * @param receiver
...
class MECP implements Comparator<Neighbor> {
	@Override
