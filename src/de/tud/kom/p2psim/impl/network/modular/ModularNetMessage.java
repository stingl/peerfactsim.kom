...
public class ModularNetMessage extends AbstractNetMessage {
	...
	ModularNetMessage(Message payload, NetID receiver, NetID sender, IStrategies strategies, NetProtocol netProtocol) {
		super(payload, receiver, sender, netProtocol);
		this.noOfFragments = strategies.getFragmentingStrategy().getNoOfFragments(payload, receiver, sender, netProtocol);
		this.size = strategies.getPacketSizingStrategy().getPacketSize(payload, receiver, sender, netProtocol, noOfFragments);
