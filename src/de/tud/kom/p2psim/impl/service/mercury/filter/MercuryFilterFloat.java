...
/**
 * This class provides a filter for a subscription of an Float.
 * 
 * @author Christoph Muenker <peerfact@kom.tu-darmstadt.de>
 * @version 05/06/2011
 */
public class MercuryFilterFloat extends AbstractMercuryFilter {
	 ...
	 */
	public MercuryFilterFloat(String name, float value, OPERATOR_TYPE operator) {
		super(name, AttributeType.Float, operator);
		this.value = value;
	}
	...
	public boolean operatorGreater(IMercuryAttribute attribute) {
		return ((Float) attribute.getValue() > this.getValue());
	}
