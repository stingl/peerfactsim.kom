...
public class MercuryContactList {
	 ...
	 * @return
	 */
	public List<MercuryContact> getAllRecipients(Comparable minValue,
			Comparable maxValue) {
	 ...
	 * @return
	 */
	public MercuryContact getContact(Comparable value) {
	 ...
	 * @return
	 */
	public MercuryContact getNearestContact(Comparable value) {
