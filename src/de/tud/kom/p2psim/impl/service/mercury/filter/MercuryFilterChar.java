...
/**
 * This class provides a filter for a subscription of an char.
 * 
 * @author Christoph Muenker <peerfact@kom.tu-darmstadt.de>
 * @version 05/06/2011
 */
public class MercuryFilterChar extends AbstractMercuryFilter {
	 ...
	 */
	public MercuryFilterChar(String name, char value, OPERATOR_TYPE operator) {
		super(name, AttributeType.Char, operator);
		this.value = value;
	}
