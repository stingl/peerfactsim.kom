...
/**
 * Simple DHT-Service, acts as a normal HashMap - used to provide basic
 * DHT-Functionality.
 * 
 ...
 * @version 05/06/2011
 */
public class SimpleDHTServiceFactory extends AbstractDHTServiceFactory {

	@Override
	public Component createComponent(Host host) {
		DHTListenerSupported node = host
				.getComponent(DHTListenerSupported.class);
		SimpleDHTService service = new SimpleDHTService();
