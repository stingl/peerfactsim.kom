...
/**
 * Response message of update requests that carries the current estimations of the responding
...
public class UpdateResponseMsg extends AbstractUpdateMsg {
	...
	public UpdateResponseMsg(long epoch, List<Tuple<Object, UpdateInfo>> payloadInfo, UpdateInfoNodeCount payloadNC) {
