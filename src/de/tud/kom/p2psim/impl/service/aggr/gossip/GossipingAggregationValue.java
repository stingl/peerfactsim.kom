...
public class GossipingAggregationValue {
	 ...
	 * ncVals.values()) { countAvgAcc += val; //System.out.println(1/val);
	 * //debug } int c = ncVals.size(); int result =
	 * (int)Math.round(c==0?-1:(c/countAvgAcc)); return result; }
	 */

	public IAggregationResult getAggregationResult() {
		if (lastAvg == Double.NaN)
