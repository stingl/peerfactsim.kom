...
public class MetricStorage implements Storage {
	...
	private LinkedList<HashMap<String, MetricsAggregate>> metricsHistory;

	// a HashMap for collecting the sending SubCoordinators including their
	// metric-aggregations
	private HashMap<BigDecimal, MetricsSubCoordinatorInfo> listOfSubCoordinators;

	// a HashMap for the metrics, collected at the own host. The own metrics are
	...
	public MetricStorage(SkyNetNodeInterface skynetNode) {
		...
		metricsHistory = new LinkedList<HashMap<String, MetricsAggregate>>();
		listOfSubCoordinators = new HashMap<BigDecimal, MetricsSubCoordinatorInfo>();
		ownMetrics = null;
	 ...
	 */
	public HashMap<BigDecimal, MetricsSubCoordinatorInfo> getListOfSubCoordinators() {
	 ...
	 */
	public LinkedList<HashMap<String, MetricsAggregate>> getMetricsHistory() {
	...
	public void setMetricsHistory(
			LinkedList<HashMap<String, MetricsAggregate>> data) {
	...
	public MetricsEntry aggregateMetrics(boolean printRoot) {
		...
		HashMap<String, MetricsAggregate> referenceMap = new HashMap<String, MetricsAggregate>();
		...
		if (listOfSubCoordinators.size() > 0) {
			...
			HashMap<String, MetricsAggregate> elem = null;
		...
		HashMap<String, MetricsAggregate> own = ownMetrics.getMetrics();
	...
	private void addMetricsMapToMetricsHistory(
			HashMap<String, MetricsAggregate> metricsMap) {
