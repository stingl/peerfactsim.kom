...
import de.tud.kom.p2psim.impl.skynet.analyzing.analyzers.KBROlAnalyzer;
import de.tud.kom.p2psim.impl.skynet.analyzing.analyzers.KBROlAnalyzer.MessageHopTupel;
import de.tud.kom.p2psim.impl.skynet.analyzing.analyzers.KBROlAnalyzer.QueryStat;
...
import de.tud.kom.p2psim.impl.skynet.queries.operations.QueryTransmissionOperation;
...
public class MetricsCollector extends AbstractMetricsCollectorDelegator {
	...
	private HashMap<String, MetricsAggregate> getStatisticsOfKBROverlay() {
		...
		OverlayNode kbrNode = skyNetNode.getHost().getOverlay(KBR.class);
	...
	private Map<String, MetricsAggregate> getReferenceMetrics() {
	...
	public MetricsEntry collectOwnData() {
		...
		HashMap<String, MetricsAggregate> map;
