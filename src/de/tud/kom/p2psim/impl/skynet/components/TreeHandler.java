...
public class TreeHandler {
	...
	void calculateResponsibilityIntervalOperationSucceeded(
			Operation<NapsterOverlayContact> op, SkyNetID ownID) {
	...
	void lookupOperationFailed(Operation<OverlayContact> op) {
		treeHandlerDelegator.lookupOperationFailed(op);
		skyNetNode.getMetricUpdateStrategy().scheduleNextUpdateEvent();
	}

	void lookupOperationSucceeded(Operation<OverlayContact> op) {
