...
import de.tud.kom.p2psim.impl.skynet.attributes.Attribute;
...
public class AttributeWriter extends AbstractSkyNetWriter {
	...
	private static final String ATTRIBUTE_DAT_PATH = "data";

	private static final String ATTRIBUTE_DAT_FILE = "Attributes.dat";

	private static final String ATTRIBUTE_OVERVIEW_FILE = "AttributeOverview.txt";
	...
	private AttributeWriter() {
		initWriteDirectory(RESULTS_PATH + File.separator
				...
				+ File.separator + ATTRIBUTE_DAT_PATH, false);
		...
		try {
			adFile = new PrintWriter(new BufferedWriter(new FileWriter(
					RESULTS_PATH
							...
							+ ATTRIBUTE_DAT_PATH + File.separatorChar
