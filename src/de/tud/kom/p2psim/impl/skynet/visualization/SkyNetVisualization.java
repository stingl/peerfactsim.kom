...
public class SkyNetVisualization extends JFrame implements Configurable,
	...
	private HashMap<String, MetricsPlot> displayedMetrics;
	...
	public void updateDisplayedMetrics(long time,
			HashMap<String, MetricsAggregate> simulatorMetrics,
			HashMap<String, MetricsAggregate> rootMetrics/* , double nodeCounter */) {
		if (activated && displayedMetrics.size() > 0) {
