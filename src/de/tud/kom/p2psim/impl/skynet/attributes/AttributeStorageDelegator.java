...
import de.tud.kom.p2psim.impl.skynet.queries.QueryCondition;
...
public class AttributeStorageDelegator {
	...
	public TreeMap<Double, AttributeEntry> getSortedEntries(
			HashMap<BigDecimal, AttributeSubCoordinatorInfo> listOfSubCoordinators) {
	...
	public TreeMap<BigDecimal, AttributeEntry> getSpecifiedNumberOfEntries(
			HashMap<BigDecimal, AttributeSubCoordinatorInfo> listOfSubCoordinators,
	...
	private boolean compareValues(Attribute attribute, QueryCondition condition) {
