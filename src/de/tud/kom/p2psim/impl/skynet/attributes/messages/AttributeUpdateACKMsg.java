 ...
 * <code>AttributeUpdateMsg</code>.
 * 
 * @author Dominik Stingl <peerfact@kom.tu-darmstadt.de>
 * @version 1.0, 15.11.2008
 * 
 */
public class AttributeUpdateACKMsg extends AbstractSkyNetMessage {

	public AttributeUpdateACKMsg(SkyNetNodeInfo senderNodeInfo,
			SkyNetNodeInfo receiverNodeInfo, long skyNetMsgID,
			boolean receiverSP, boolean senderSP) {
		super(senderNodeInfo, receiverNodeInfo, skyNetMsgID, true, receiverSP,
				senderSP);
	}
