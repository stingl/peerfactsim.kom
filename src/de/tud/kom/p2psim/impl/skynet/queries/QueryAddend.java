...
public class QueryAddend implements Serializable {
	...
	private HashMap<BigDecimal, QueryReplyingPeer> replyingPeers;
	...
	public QueryAddend(int searchedElements) {
		...
		this.replyingPeers = new HashMap<BigDecimal, QueryReplyingPeer>();
	}
	 ...
	 */
	public HashMap<BigDecimal, QueryReplyingPeer> getReplyingPeers() {
	...
	public long getSize() {
		return SkyNetConstants.SKY_NET_NODE_INFO_SIZE
				...
				* (SkyNetConstants.OVERLAY_ID_SIZE + SkyNetConstants.QUERY_REPLYING_PEER_SIZE)
				...
				+ SkyNetConstants.INT_SIZE + conditions.size()
				* SkyNetConstants.QUERY_CONDITION_SIZE_ESTIMATE;
	}

	@Override
	public String toString() {
		String ret = searchedElements + " with ";
		for (int i = 0; i < conditions.size(); i++) {
			ret = ret + conditions.get(i).toString();
