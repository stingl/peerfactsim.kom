...
import de.tud.kom.p2psim.impl.skynet.attributes.AttributeStorage;
import de.tud.kom.p2psim.impl.skynet.queries.messages.QueryForwardMsg;
import de.tud.kom.p2psim.impl.skynet.queries.operations.QueryForwardOperation;
...
public class QueryHandler {
	...
	private HashMap<Integer, QueryTransmissionOperation> openQueries;
	...
	public QueryHandler(SkyNetNodeInterface skyNetNode, AttributeStorage storage) {
		...
		openQueries = new HashMap<Integer, QueryTransmissionOperation>();
