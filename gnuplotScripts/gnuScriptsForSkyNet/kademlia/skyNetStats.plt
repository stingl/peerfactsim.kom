...
"../data/Metrics.dat" using 1:52 ti"Counted Online-Peers"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:($5*100) ti"AverageRecBandwidthConsumption",\
"../data/Metrics.dat" using 1:($6*100) ti"AverageSentBandwidthConsumption",\
"../data/Metrics.dat" using 1:($54*100) ti"Measured AverageRecBandwidthConsumption",\
"../data/Metrics.dat" using 1:($55*100) ti"Measured AverageSentBandwidthConsumption"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:16 ti"Received Messages",\
"../data/Metrics.dat" using 1:30 ti"Sent Messages",\
"../data/Metrics.dat" using 1:65 ti"Measured Received Messages",\
"../data/Metrics.dat" using 1:79 ti"Measured Sent Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:19 ti"Received Overlay-Messages",\
"../data/Metrics.dat" using 1:33 ti"Sent Overlay-Messages",\
"../data/Metrics.dat" using 1:68 ti"Measured Received Overlay-Messages",\
"../data/Metrics.dat" using 1:82 ti"Measured Sent Overlay-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:28 ti"Received SkyNet-Messages",\
"../data/Metrics.dat" using 1:42 ti"Sent SkyNet-Messages",\
"../data/Metrics.dat" using 1:77 ti"Measured Received SkyNet-Messages",\
"../data/Metrics.dat" using 1:91 ti"Measured Sent SkyNet-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:18 ti"Received MetricUpdate-Messages",\
"../data/Metrics.dat" using 1:32 ti"Sent MetricUpdate-Messages",\
"../data/Metrics.dat" using 1:74 ti"Measured Received MetricUpdate-Messages",\
"../data/Metrics.dat" using 1:88 ti"Measured Sent MetricUpdate-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:17 ti"Received MetricUpdateACK-Messages",\
"../data/Metrics.dat" using 1:31 ti"Sent MetricUpdateACK-Messages",\
"../data/Metrics.dat" using 1:73 ti"Measured Received MetricUpdateACK-Messages",\
"../data/Metrics.dat" using 1:87 ti"Measured Sent MetricUpdateACK-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:15 ti"Received AttributeUpdate-Messages",\
"../data/Metrics.dat" using 1:29 ti"Sent AttributeUpdate-Messages",\
"../data/Metrics.dat" using 1:64 ti"Measured Received AttributeUpdate-Messages",\
"../data/Metrics.dat" using 1:78 ti"Measured Sent AttributeUpdate-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:23 ti"Network-Traffic of rec Messages",\
"../data/Metrics.dat" using 1:37 ti"Network-Traffic of sent Messages",\
"../data/Metrics.dat" using 1:72 ti"Measured Network-Traffic of rec Messages",\
"../data/Metrics.dat" using 1:86 ti"Measured Network-Traffic of sent Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:26 ti"Network-Traffic of rec Overlay-Messages",\
"../data/Metrics.dat" using 1:40 ti"Network-Traffic of sent Overlay-Messages",\
"../data/Metrics.dat" using 1:75 ti"Measured Network-Traffic of rec Overlay-Messages",\
"../data/Metrics.dat" using 1:89 ti"Measured Network-Traffic of sent Overlay-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:27 ti"Network-Traffic of rec SkyNet-Messages",\
"../data/Metrics.dat" using 1:41 ti"Network-Traffic of sent SkyNet-Messages",\
"../data/Metrics.dat" using 1:76 ti"Measured Network-Traffic of rec SkyNet-Messages",\
"../data/Metrics.dat" using 1:91 ti"Measured Network-Traffic of sent SkyNet-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:25 ti"Network-Traffic of rec MetricUpdate-Messages",\
"../data/Metrics.dat" using 1:39 ti"Network-Traffic of sent MetricUpdate-Messages",\
"../data/Metrics.dat" using 1:74 ti"Measured Network-Traffic of rec MetricUpdate-Messages",\
"../data/Metrics.dat" using 1:88 ti"Measured Network-Traffic of sent MetricUpdate-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:24 ti"Network-Traffic of rec MetricUpdateACK-Messages",\
"../data/Metrics.dat" using 1:38 ti"Network-Traffic of sent MetricUpdateACK-Messages",\
"../data/Metrics.dat" using 1:73 ti"Measured Network-Traffic of rec MetricUpdateACK-Messages",\
"../data/Metrics.dat" using 1:87 ti"Measured Network-Traffic of sent MetricUpdateACK-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:22 ti"Network-Traffic of rec AttributeUpdate-Messages",\
"../data/Metrics.dat" using 1:36 ti"Network-Traffic of sent AttributeUpdate-Messages",\
"../data/Metrics.dat" using 1:64 ti"Measured Network-Traffic of rec AttributeUpdate-Messages",\
"../data/Metrics.dat" using 1:85 ti"Measured Network-Traffic of sent AttributeUpdate-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:20 ti"Received Query-Messages",\
"../data/Metrics.dat" using 1:34 ti"Sent Query-Messages",\
"../data/Metrics.dat" using 1:69 ti"Measured Received Query-Messages",\
"../data/Metrics.dat" using 1:83 ti"Measured Sent Query-Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:21 ti"Query-Traffic of rec Messages",\
"../data/Metrics.dat" using 1:35 ti"Query-Traffic of sent Messages",\
"../data/Metrics.dat" using 1:70 ti"Measured Query-Traffic of rec Messages",\
"../data/Metrics.dat" using 1:84 ti"Measured Query-Traffic of sent Messages"
...
set style data linespoints
plot "../data/Metrics.dat" using 1:4 ti"Query-Time",\
"../data/Metrics.dat" using 1:53 ti"Measured Query-Time"
...
plot "../data/Metrics.dat" using 1:101 ti"Free Memory",\
"../data/Metrics.dat" using 1:102 ti"Total Memory",\
"../data/Metrics.dat" using 1:103 ti"Max Memory",\
"../data/Metrics.dat" using 1:($102-$101) ti"Consumed Memory"
